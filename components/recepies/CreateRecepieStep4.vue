              ...
              <v-row>
                <v-col cols="12">
                  ...
                  <div class="d-flex align-center">
                    ...
                    <v-chip class="ml-2" color="primary">{{ value.access == 0 ? 'Publique' : 'Privée' }}</v-chip>
                  </div>
                </v-col>
                <v-col cols="12">
                        ...
                        <v-list-item outlined class="fwidth outlined-list-item mb-2">
                          ...
                          <v-list-item-content>
                            <v-list-item-title class="font-weight-bold subtitle"
                              >{{ e.count }} {{ e.unit.label }} {{ e.item.label_fr }}
            ...
            <v-col cols="12" md="6">
              <v-row>
                ...
                <v-col cols="4">
                  ...
                  <p>
                    <b class="primary--text font-weight-bold">{{ value.person_count }} {{ value.person_count_unit }}</b>
                  </p>
                </v-col>
                <v-col cols="4">
                ...
                <v-col cols="12">
                  ...
                  <v-row>
                    <v-list class="fwidth pr-8" v-if="value.instructions && value.instructions.length > 0">
                      <v-list-item
