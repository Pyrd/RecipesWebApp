                    ...
                    <v-form ref="form" v-model="form" lazy-validation>
                        ...
                        <v-row class="d-flex flex-column mb-2">
                            ...
                            <v-alert
                                ...
                                outlined
                                type="error"
                            >Indiquer le type de recette</v-alert>
                        </v-row>
                        <!-- Nombre de portions -->
                        <v-row class="d-flex flex-column mb-2">
                        ...
                        <v-row class="d-flex flex-column">
                            ...
                            <v-alert
                                v-if="errors.preparation"
                                dense
                                outlined
                                type="error"
                            >Indiquer le temps de préparation</v-alert>
                        </v-row>
                        <!-- Temps de cuisson -->
                        <v-row class="d-flex flex-column mb-2">
                            ...
                            <v-alert
                                ...
                                outlined
                                type="error"
                            >Indiquer le temps de cuisson</v-alert>
                        </v-row>
                        <!-- Temps de repos -->
                        <v-row class="d-flex flex-column mb-2">
                            ...
                            <v-alert
                                ...
                                outlined
                                type="error"
                            >Indiquer le temps de repos</v-alert>
                        </v-row>
                        <!-- Types de cuisson -->
                        <v-row class="d-flex flex-column mb-2">
                            ...
                            <v-alert
                                v-if="errors.cook_type"
                                dense
                                outlined
                                type="error"
                            >Indiquer le type de cuisson</v-alert>
                        </v-row>
                        <!-- Difficulty -->
                        <v-row class="d-flex flex-column mb-2">
                            ...
                            <v-alert
                                ...
                                outlined
                                type="error"
                            >Indiquer la difficulté</v-alert>
                        </v-row>
                        <!-- Cost -->
                        <v-row class="d-flex flex-column mb-2">
...
export default {
    ...
    computed: {
        ...
        checkFormValidity() {
            ...
            console.log(Object.keys(this.errors).map((e) => this.errors[e]), Object.keys(this.errors).map((e) => this.errors[e]).reduce((prev, curr, i) => {
                return prev && curr
            }))
